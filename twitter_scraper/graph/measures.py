...
def get_strenghts_dict(g, weight_value):
...
def network_measures_distribution():
    ...
    graph_functions = [
        ...
        #('Strength distribution', lambda g: get_strenghts_dict(g, 'duration')), 
        ('Betweenness centrality', lambda g: nx.betweenness_centrality(g, weight=None)),
        ('Clustering coefficient', lambda g: nx.clustering(g, weight='duration'))
    ]
